...
1. **Linearità**: Le relazioni tra predittori e variabile dipendente sono lineari
2. **Indipendenza**: Le osservazioni sono indipendenti
3. **Omoschedasticità**: Varianza costante dei residui
4. **Normalità**: I residui seguono una distribuzione normale
5. **Assenza di Multicollinearità**: Verificata dalle correlazioni basse tra predittori (< 0.11)

### Diagnosi dai Grafici
- **Matrice di Dispersione**: Conferma relazioni approssimativamente lineari
- **Fitted vs Observed**: Mostra buona aderenza alla linea ideale per valori medi, con maggiore dispersione agli estremi
...
### Sviluppi Futuri
Il modello M2 stabilisce una solida base per sviluppi futuri che potrebbero includere:
- Variabili categoriche (sesso, stato di fumatore, regione)
